      ...
      <div className="container" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64, padding: '0 16px' }}>
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
          <div style={{
            ...
            <span style={{ fontSize: '6px', fontWeight: 900, color: 'var(--primary)', letterSpacing: '0.5px', lineHeight: 1 }}>TEKBIZ</span>
          </div>
        </Link>
...
function HeroSection() {
  ...
  return (
    <section style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', background: 'var(--bg)', color: 'var(--text)', paddingTop: 110, paddingBottom: 60, position: 'relative', overflow: 'hidden', transition: 'background 0.3s, color 0.3s' }}>
      ...
      <div style={{ position: 'absolute', top: '10%', right: '-10%', width: 450, height: 450, background: 'radial-gradient(circle, rgba(249,115,22,0.06) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
      <div style={{ position: 'absolute', bottom: '10%', left: '-10%', width: 450, height: 450, background: 'radial-gradient(circle, rgba(16,185,129,0.04) 0%, transparent 70%)', borderRadius: '50%', pointerEvents: 'none' }} />
      ...
      <div className="container" style={{ position: 'relative', zIndex: 1, padding: '0 16px' }}>
        <div className="hero-grid">
          ...
          <div className="hero-text-col">
            ...
            <p style={{ fontSize: 'clamp(0.95rem, 2.5vw, 1.0625rem)', maxWidth: 460, marginBottom: 32, color: 'var(--text-secondary)', lineHeight: 1.6, fontWeight: 400 }}>
              {t('heroSubtitle')}
            </p>
            ...
            <div className="hero-buttons">
              ...
              <Link href="#demo" className="btn-secondary-custom">
                {t('seeDemo')}
              </Link>
            </div>
            ...
            <div className="hero-social-proof">
              <div style={{ display: 'flex', alignItems: 'center' }}>
                <div style={{ width: 30, height: 30, borderRadius: '50%', border: '2px solid var(--bg)', background: 'linear-gradient(135deg, #3B82F6, #1D4ED8)', zIndex: 3 }} />
                <div style={{ width: 30, height: 30, borderRadius: '50%', border: '2px solid var(--bg)', background: 'linear-gradient(135deg, #10B981, #047857)', marginLeft: -10, zIndex: 2 }} />
                <div style={{ width: 30, height: 30, borderRadius: '50%', border: '2px solid var(--bg)', background: 'linear-gradient(135deg, #EC4899, #BE185D)', marginLeft: -10, zIndex: 1 }} />
              </div>
...
function FeaturesSection() {
  ...
  return (
    <section style={{ padding: '80px 0', background: 'var(--bg-secondary)', transition: 'background 0.3s' }}>
...
function StepsSection() {
  ...
  return (
    <section style={{ padding: '80px 0', background: 'var(--bg)', transition: 'background 0.3s' }}>
      <div className="container">
        <h2 style={{ textAlign: 'center', marginBottom: 48, fontWeight: 800 }}>{t('howItWorks')}</h2>
          ...
          {steps.map((s, i) => (
            <div key={i} style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <h4 style={{ marginBottom: 4, fontWeight: 700 }}>{s.title}</h4>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.875rem', lineHeight: 1.5 }}>{s.desc}</p>
              </div>
            </div>
          ))}
        </div>
...
function PricingSection() {
  ...
  return (
    <section style={{ padding: '80px 0', background: 'var(--bg-secondary)', transition: 'background 0.3s' }}>
      <div className="container">
        <h2 style={{ textAlign: 'center', marginBottom: 8, fontWeight: 800 }}>{t('pricingTitle')}</h2>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24, maxWidth: 680, margin: '0 auto' }}>
          {/* Free */}
          <div className="card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '380px' }}>
            <div>
              <h4 style={{ marginBottom: 4, fontWeight: 700 }}>{t('freePlan')}</h4>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.25rem', fontWeight: 900, marginBottom: 20 }}>0 <span style={{ fontSize: '0.875rem', fontWeight: 500, color: 'var(--text-tertiary)' }}>FCFA</span></div>
          ...
          {/* Pro */}
          <div className="card" style={{ border: '2px solid var(--primary)', position: 'relative', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', minHeight: '380px', boxShadow: 'var(--shadow-md)' }}>
            ...
            <div>
              <h4 style={{ marginBottom: 4, fontWeight: 700 }}>{t('proPlan')}</h4>
              <div style={{ fontFamily: 'var(--font-display)', fontSize: '2.25rem', fontWeight: 900, marginBottom: 20 }}>5 000 <span style={{ fontSize: '0.875rem', fontWeight: 500, color: 'var(--text-tertiary)' }}>FCFA{t('perMonth')}</span></div>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginBottom: 24 }}>
...
function Footer() {
  const { t } = useLanguage();
  return (
    <footer style={{ padding: '40px 0', background: 'var(--bg)', color: 'var(--text-secondary)', textAlign: 'center', fontSize: '0.875rem', borderTop: '1px solid var(--border)', transition: 'background 0.3s, border-color 0.3s' }}>
      <div className="container">
